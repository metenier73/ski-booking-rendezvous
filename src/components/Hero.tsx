...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23e0f2fe" fill-opacity="0.3"%3E%3Ccircle cx="30" cy="30" r="4"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-20"></div>
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="flex items-center space-x-3 text-blue-600">
                ...
                <span className="text-lg font-semibold">Monitrice ESF Diplômée</span>
              </div>
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                Plus de 10 ans d'expérience pour vous accompagner dans votre progression, 
                du débutant au skieur confirmé. Cours personnalisés aux Deux Alpes.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              ...
              <div className="text-center">
                ...
                <div className="text-2xl font-bold text-green-600">ESF</div>
              ...
              <div className="aspect-square bg-white rounded-2xl shadow-lg flex items-center justify-center">
                <div className="text-center space-y-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-2xl font-bold text-gray-900">Sarah Dubois</h3>
                    <p className="text-blue-600 font-semibold">Monitrice ESF</p>
                    <p className="text-gray-600">Les Deux Alpes</p>
                  </div>
                </div>
              </div>
